...
<div class="product-section mt-150 mb-150">
	<div class="container">
		...
		<div class="row product-lists">
			<?php
			$q = mysqli_query($conn, " SELECT p.id,c.category_name,sc.sub_category_name,p.product_name,
			p.product_price,p.discount_price,p.sub_category_id,p.status FROM products p JOIN categories c 
			ON p.category_id = c.id   JOIN sub_categories sc ON p.sub_category_id = sc.id ");
			$sr_no = 1;
			...
			?>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<a href="save_carts.php?id=<?php echo $row['id']; ?>" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
			<?php
			};
